...
<div class="col-xs-12">
  ...
  <body>
    ...
    <form method="post" action="services/guardamiPerfilInvitadoEditado.php">
      ...
      <h6 class="text-center">Cuenta de Usuario:</h6>
      ...
      <input class="controlsasimilados" type="text" name="Rol" placeholder="Usuario" readonly>
      ...
      <h2 class="text-center" style=""><b>Rol: <?php echo $_SESSION['tipoUser'];?></b></h2>    -->
        ...
        <a href="miperfilInvitado.php" class="btn btn-warning" role="button" style="margin-left: 10px;">Cancelar</a>

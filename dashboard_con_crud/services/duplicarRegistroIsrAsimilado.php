...
// $resultado = $sentencia->execute([$idArea]);
 ...
 $stm1=$conex->prepare("SELECT * FROM israsimilados WHERE id_isr=".$IdIsrAsimi);
 $stm1->execute();
...
$stmt = $conex->prepare("INSERT INTO israsimilados (sueldoinf,sueldosup,limiteinf,limitesup,coutafija,porcentaje,anio,tipo) VALUES (".$output[0].", ". $output[1].", ". $output[2].", ". $output[3].",". $output[4].",". $output[5].",". $output[6].",'". $output[7]."');");

...
if(isset($_POST['estado'])){    
    ...
    {  //aqui inserta el nuevo registro en la tabla correspondiente evitando sql injection
        $stmt = $conex->prepare("INSERT INTO impuestosnomina(Estado,Porcentaje,Descripcion,anio) values (?,?,?,?)");//manda 0 como inactivo el usuario
        $stmt->bind_param('sdsi', $estado, $porcentaje, $descripcion,$anio);          
        $stmt->execute();

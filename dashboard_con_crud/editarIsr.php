...
$stmt = $conex->prepare("SELECT * FROM isr WHERE id_isr = ?;");
            $stmt->bind_param('i', $idIsr);
            $stmt->execute();
...
<div class="container" style="width: 500px; margin: 0 auto;">
	...
	?>
		<h1 class="text-center">Editar Registro de ISR </h1>
		<form class="formulario" name="formulario-editarIsr" id="form-editarIsr">
	...
	<?php } ?>
			<br><CENTER><input class="btn btn-primary" type="button" id="btn-edit-isr" value="Guardar"><a class="btn btn-danger" href="isr.php">Cancelar</a></CENTER>
		</form>
	</div>
    </div>
	</div>

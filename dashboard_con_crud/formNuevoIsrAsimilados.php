...
<h1 class="text-center">Agregar un nuevo registro de ISR Asimilado</h1>
<div class="container"  style="width: 500px; margin: 0 auto;" >
		<div class="row">
            
<div class="col-md-12 text-center ">
	<!-- <h1 class="text-center">Agregar un nuevo usuario al sistema</h1> -->
	<form class="formulario" name="formulario-isrAsimi" id="form-isrAsimi">
		...
		<br><br><center><input class="btn btn-primary" id="btn-new-isrAsimi" type="button" value="Guardar"><a class="btn btn-danger" href="isrAsimilados.php">Cancelar</a></center>
	</form>
    </div>
   	</div>
	</div>

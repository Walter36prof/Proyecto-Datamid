...
<h1 class="text-center">Agregar nuevo registro de subsidio asimilados</h1>
<div class="container"  style="width: 500px; margin: 0 auto;" >
		<div class="row">
            
<div class="col-md-12 text-center ">
	<!-- <h1 class="text-center">Agregar un nuevo usuario al sistema</h1> -->
	<form class="formulario" name="formulario-tsubsidioasimilados" id="form-tsubsidioasimilados">
		...
		<!-- <input class="form-control" name="tipo" required type="text" id="tipo" placeholder="Escribe el tipo">   -->
		...
		<br><center><input class="btn btn-primary" id="btn-new-tsubsidioasimilados" type="button" value="Guardar"><a class="btn btn-danger" href="tsubsidioasimilados.php">Cancelar</a></center>
	</form>
</div>
   		</div>
	</div>

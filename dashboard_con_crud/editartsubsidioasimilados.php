...
$stmt = $conex->prepare("SELECT * FROM tsubsidioasimilados WHERE idSubsidio = ?;");
...
<div class="container" style="width: 500px; margin: 0 auto;">
	...
	?>
		<h1 class="text-center">Editar Registro de subsidio Asimilado</h1>
		<form class="formulario" name="formulario-editartsubsidioasimilados" id="form-editartsubsidioasimilados">
	...
	<?php } ?>
			<br><CENTER><input class="btn btn-primary" type="button" id="btn-edit-tsubsidioasimilados" value="Guardar"><a class="btn btn-danger" href="tsubsidioasimilados.php">Cancelar</a></CENTER>
		</form>
	</div>
    </div>
	</div>

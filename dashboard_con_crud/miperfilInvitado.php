  ...
  <body>
    ...
    <h5>MI PERFIL</h5>
      ...
      <h2 class="text-center" style=""><b>Rol: <?php echo $_SESSION['tipoUser'];?></b></h2>    
        ...
        <center>
        <button type="button" class="btn btn-primary" style="margin-right: 10px;" onclick="window.location.href='catalogoInvitado.php';">Aceptar</button>
        <a href="miperfilEditarInvitado.php" class="btn btn-warning" role="button" style="margin-left: 10px;">Editar</a>
